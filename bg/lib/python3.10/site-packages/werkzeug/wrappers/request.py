...
class Request(_SansIORequest):
    ...
    def _get_file_stream(
        ...
        :param content_type: the mimetype of the uploads file.
        :param filename: the filename of the uploads file.  May be `None`.
    ...
    def files(self) -> "ImmutableMultiDict[str, FileStorage]":
        ...
        all uploads files.  Each key in :attr:`files` is the name from the
